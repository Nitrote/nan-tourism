...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#3D2B3D] text-white/70">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Way Back Home</h3>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-xs text-white/40">
          <p>&copy; {new Date().getFullYear()} Way Back Home / เยือนบ้านเฮา. {t("footer.rights")}</p>
        </div>
      </div>
    </footer>
  );
