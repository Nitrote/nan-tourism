    ...
    <div className="bg-[var(--color-warm)]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <section className="mb-16">
          <span className="inline-block bg-[var(--color-forest)] text-white text-sm tracking-[0.2em] uppercase font-medium px-3 py-1.5 rounded-full mb-3">
            Why Nan
          </span>
        ...
        {/* History */}
        <section className="mb-16 bg-[var(--color-forest-tint)] rounded-3xl p-8 -mx-8">
          <span className="inline-block bg-[var(--color-forest)] text-white text-sm tracking-[0.2em] uppercase font-medium px-3 py-1.5 rounded-full mb-3">
            Heritage
          </span>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-2xl p-6 shadow-sm border-t-[3px] border-[var(--color-forest)]">
              <div className="w-3 h-3 rounded-full bg-[var(--color-forest)] mb-4" />
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border-t-[3px] border-[var(--color-golden)]">
              <div className="w-3 h-3 rounded-full bg-[var(--color-golden)] mb-4" />
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border-t-[3px] border-[var(--color-forest-dark)]">
              <div className="w-3 h-3 rounded-full bg-[var(--color-forest-dark)] mb-4" />
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border-t-[3px] border-[var(--color-sky)]">
              <div className="w-3 h-3 rounded-full bg-[var(--color-sky)] mb-4" />
